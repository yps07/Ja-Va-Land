...
public class Level2 implements Screen {
    ...
    private static final int level_no = 2;
    ...
    public void show() {
        ...
        if(!is_loaded) {
            ...
            s_pig2 = new SmallPig();
            m_pig2 = new MediumPig();

            s_pig.setPosition(850, 60);
            m_pig.setPosition(848, 140);
            l_pig.setPosition(846, 238);

            s_pig2.setPosition(750, 60);
            m_pig2.setPosition(748, 140);
            ...
            w4 = new Wood("wood1.png");
            w4.setSize(20, 70);
            w5 = new Wood("wood.png");
            w5.setSize(120, 20);
            ...
            w4.setPosition(695, 75);
            w5.setPosition(740, 110);
            ...
            m4.setPosition(695, 155);
            m5.setPosition(740, 200);
            ...
            pigs_list.add(m_pig);
            pigs_list.add(l_pig);
            pigs_list.add(s_pig2);
            pigs_list.add(m_pig2);
